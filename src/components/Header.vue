...
const FacebookLink = 'https://www.facebook.com/nogames231';
        ...
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-xl">James Alf Ochea</h1>
                    <p class="font-light text-lg text-gray-600">BSIT-4B Student in Cordova Public College</p>
                </router-link>
